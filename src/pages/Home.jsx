  ...
  return (
    <>
      <div className='h-screen w-screen flex justify-center items-center bg-[url(/img/bg-secondary.jpg)] bg-no-repeat bg-cover bg-center'>
        <div className='flex flex-col gap-2 font-lilita mx-auto text-center text-white w-[90%]'>
          <h1 className='text-[94px] leading-[3rem]'>Welcome to Quizy!</h1>
          ...
          <button className='w-[268px] h-[84px] bg-[#D9D9D9] bg-opacity-[10%] border-2 border-white border-solid rounded-[1rem] mx-auto my-4'>
            <Link to='category' className='font-inter font-medium text-[24px]'>Get Started</Link>
          </button>
        </div>
      </div>
    </>
