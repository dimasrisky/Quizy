...
const QuizStarted = ({ dataQuiz, setCorrectPoint, setIncorrectPoint, setState }) => {
  ...
  const decodedQuestion = question ? he.decode(question) : '';
  ...
  return (
    <>
      <div className='h-[100vh] bg-[url(../../public/img/bg-primary.jpg)] bg-no-repeat bg-cover bg-center text-white pt-[20vh] text-center'>
